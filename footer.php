...
?>
	...
	<!--<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="site-info">
			<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'paula_fernandes' ) ); ?>"><?php printf( esc_html__( 'Proudly powered by %s', 'paula_fernandes' ), 'WordPress' ); ?></a>
			<span class="sep"> | </span>
			<?php printf( esc_html__( 'Theme: %1$s by %2$s.', 'paula_fernandes' ), 'paula_fernandes', '<a href="http://underscores.me/" rel="designer">Underscores.me</a>' ); ?>
		<!-- my code-->
		<footer>
			Ruben Fernandez  <?php echo myFunction(); ?>
			<div class="social-media-icons">
<div>
<a href="https://twitter.com/paulafernandes7">
<img title="Twitter" alt="Twitter" src="https://socialmediawidgets.files.wordpress.com/2014/03/01_twitter.png" width="35" height="35" />
</a>
<a href="https://www.pinterest.com/apaixonado/love-paula-fernandes/">
...
<a href="https://www.facebook.com/OficialPaulaFernandes">
...
<a href="https://instagram.com/paulafernandes/">
